    ...
    <div>
      ...
      <div className={gameSession.startedAt ? "" : "displayNone"}>
        ...
        <table>
          <tbody>
            <tr>
              <td className="horizontal-line" id="0"></td>
              <td className="vertical-line horizontal-line" id="1"></td>
              <td className="vertical-line horizontal-line" id="2"></td>
            </tr>
            <tr>
              <td className="horizontal-line" id="3"></td>
              <td className="vertical-line horizontal-line" id="4" ></td>
              <td className="vertical-line horizontal-line" id="5"></td>
            </tr>
            <tr>
              <td id="6"></td>
              <td className="vertical-line" id="7"></td>
              <td className="vertical-line" id="8"></td>
            </tr>
          </tbody>
        </table>
        <br />
